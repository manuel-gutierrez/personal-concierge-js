...
describe('#Facebook markSeen Method', () => {
	...
	it("markSeen should fail on bad user Id statusCode 400", function(done) {
	...
	it("markSeen should be Ok 200", function(done) {
