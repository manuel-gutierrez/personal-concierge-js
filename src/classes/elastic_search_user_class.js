...
/*
Class: Elastic Search user CRUD
This Class create delete and update and user on elastic search user index.
*/


class elasticUser {
 
	constructor(userAuth, password) {
		this.options = {
	        url: `https://e1822f0b7e239bcc6dab870f135bb256.us-east-1.aws.found.io:9243/users/user/`,
	        headers : {
	...
	get(userId) {
		...
		opts.url = opts.url+"_search?q=user_id:"+userId;
